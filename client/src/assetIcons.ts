...
export const INVENTORY_ITEM_ICON_SRC: Partial<Record<ItemId, string>> = {
  ...
  duelist_challenge_skill_book: `${skillBookIconPath}/blade-aegis/duelist_challenge_skill_book.png`,
  second_wind_skill_book: `${skillBookIconPath}/blade-aegis/second_wind_skill_book.png`,
  blade_parry_skill_book: `${skillBookIconPath}/blade-aegis/blade_parry_skill_book.png`,
  edge_focus_skill_book: `${skillBookIconPath}/blade-aegis/edge_focus_skill_book.png`,
  press_the_opening_skill_book: `${skillBookIconPath}/blade-aegis/press_the_opening_skill_book.png`,
  woodcutter_rhythm_skill_book: `${skillBookIconPath}/blade-aegis/woodcutter_rhythm_skill_book.png`,
  flash_step_skill_book: `${skillBookIconPath}/blade-aegis/flash_step_skill_book.png`,
  sweeping_strike_skill_book: `${skillBookIconPath}/blade-aegis/sweeping_strike_skill_book.png`,
  shield_challenge_skill_book: `${skillBookIconPath}/blade-aegis/shield_challenge_skill_book.png`,
  hold_fast_skill_book: `${skillBookIconPath}/blade-aegis/hold_fast_skill_book.png`,
  guard_wall_skill_book: `${skillBookIconPath}/blade-aegis/guard_wall_skill_book.png`,
  iron_stance_skill_book: `${skillBookIconPath}/blade-aegis/iron_stance_skill_book.png`,
  shield_formation_skill_book: `${skillBookIconPath}/blade-aegis/shield_formation_skill_book.png`,
  stonebreaker_rhythm_skill_book: `${skillBookIconPath}/blade-aegis/stonebreaker_rhythm_skill_book.png`,
  shield_rush_skill_book: `${skillBookIconPath}/blade-aegis/shield_rush_skill_book.png`,
  shield_shockwave_skill_book: `${skillBookIconPath}/blade-aegis/shield_shockwave_skill_book.png`,
  pinning_shot_skill_book: `${skillBookIconPath}/hunter-beast/pinning_shot_skill_book.png`,
  fake_death_skill_book: `${skillBookIconPath}/hunter-beast/fake_death_skill_book.png`,
  evasive_instinct_skill_book: `${skillBookIconPath}/hunter-beast/evasive_instinct_skill_book.png`,
  hunters_focus_skill_book: `${skillBookIconPath}/hunter-beast/hunters_focus_skill_book.png`,
  poison_coating_skill_book: `${skillBookIconPath}/hunter-beast/poison_coating_skill_book.png`,
  herbalist_rhythm_skill_book: `${skillBookIconPath}/hunter-beast/herbalist_rhythm_skill_book.png`,
  skirmish_shot_skill_book: `${skillBookIconPath}/hunter-beast/skirmish_shot_skill_book.png`,
  arrow_burst_skill_book: `${skillBookIconPath}/hunter-beast/arrow_burst_skill_book.png`,
  threatening_roar_skill_book: `${skillBookIconPath}/hunter-beast/threatening_roar_skill_book.png`,
  blood_feast_skill_book: `${skillBookIconPath}/hunter-beast/blood_feast_skill_book.png`,
  rugged_hide_skill_book: `${skillBookIconPath}/hunter-beast/rugged_hide_skill_book.png`,
  feral_surge_skill_book: `${skillBookIconPath}/hunter-beast/feral_surge_skill_book.png`,
  pack_frenzy_skill_book: `${skillBookIconPath}/hunter-beast/pack_frenzy_skill_book.png`,
  stoneclaw_rhythm_skill_book: `${skillBookIconPath}/hunter-beast/stoneclaw_rhythm_skill_book.png`,
  pounce_skill_book: `${skillBookIconPath}/hunter-beast/pounce_skill_book.png`,
  maul_sweep_skill_book: `${skillBookIconPath}/hunter-beast/maul_sweep_skill_book.png`,
