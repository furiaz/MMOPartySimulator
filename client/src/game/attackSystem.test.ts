...
describe("enemy attack leash movement", () => {
  ...
  it("starts Elementalist basic attack range at four cells", () => {
    const companion = createIdleCompanion("leader", { x: 0, y: 0 }, "elementalist");
  ...
  it("starts Lightbearer basic attack range at four cells", () => {
    const companion = createIdleCompanion("leader", { x: 0, y: 0 }, "lightbearer");
  ...
  it("lets Elementalist basic attacks launch magic projectiles from ranged distance", () => {
    const companion = {
      ...createAttackingCompanion("leader", { x: 4, y: 0 }, 0, "elementalist"),
      lastAttackAt: -2000,
    };
    const enemy = createEnemy("enemy", { x: 0, y: 0 }, undefined, {
      enemyTypeId: "slime",
  ...
  it("lets Lightbearer basic attacks launch holy magic projectiles from ranged distance", () => {
    const companion = {
      ...createAttackingCompanion("leader", { x: 4, y: 0 }, 0, "lightbearer"),
      lastAttackAt: -2000,
    };
    const enemy = createEnemy("enemy", { x: 0, y: 0 }, undefined, {
      enemyTypeId: "slime",
