...
const BASE_MERCHANT_BUY_STOCK: MerchantStockEntry[] = [
  ...
  { itemId: "resourcefulness_skill_book", priceCrowns: 25, group: "books" },
  { itemId: "steady_nerves_skill_book", priceCrowns: 25, group: "books" },
  ...
  { itemId: "duelists_momentum_skill_book", priceCrowns: 60, group: "books" },
  { itemId: "riposte_training_skill_book", priceCrowns: 60, group: "books" },
  ...
  { itemId: "rooted_bastion_skill_book", priceCrowns: 60, group: "books" },
  { itemId: "unbroken_line_skill_book", priceCrowns: 60, group: "books" },
  ...
  { itemId: "headhunter_skill_book", priceCrowns: 60, group: "books" },
  { itemId: "exploit_the_snare_skill_book", priceCrowns: 60, group: "books" },
  ...
  { itemId: "blood_scent_skill_book", priceCrowns: 60, group: "books" },
  { itemId: "pack_instinct_skill_book", priceCrowns: 60, group: "books" },
  ...
  { itemId: "stable_overcharge_skill_book", priceCrowns: 60, group: "books" },
  { itemId: "arcane_crescendo_skill_book", priceCrowns: 60, group: "books" },
  ...
  { itemId: "word_resonance_skill_book", priceCrowns: 60, group: "books" },
  { itemId: "living_inscription_skill_book", priceCrowns: 60, group: "books" },
  ...
  { itemId: "overflowing_grace_skill_book", priceCrowns: 60, group: "books" },
  { itemId: "many_beacons_skill_book", priceCrowns: 60, group: "books" },
  ...
  { itemId: "crimson_authority_skill_book", priceCrowns: 60, group: "books" },
  { itemId: "cruel_mercy_skill_book", priceCrowns: 60, group: "books" },
