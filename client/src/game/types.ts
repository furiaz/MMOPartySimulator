...
export type MapVisualObjectId =
  ...
  | "ash_goblin_charred_dead_tree_trunk"
  | "ash_goblin_ash_bent_dead_tree"
  | "ash_goblin_goblin_spike_barricade"
  | "ash_goblin_goblin_watch_post"
  | "ash_goblin_ember_campfire_pit"
  | "ash_goblin_ash_rock_cluster"
  | "ash_goblin_broken_cart_debris"
  | "ash_goblin_bone_skull_warning_totem"
  | "ash_goblin_sooty_tent_leanto"
  | "ash_goblin_burned_log_pile"
  | "ash_goblin_charcoal_scorch_patch"
  | "briar_large_briar_thicket"
  | "briar_burrow_mound_entrance"
  | "briar_twisted_root_arch"
  | "briar_mire_stone_cluster"
  | "briar_thorn_fence_bramble_wall"
  | "briar_spider_webbed_root_stump"
  | "briar_muddy_insect_tunnel_holes"
  | "briar_wolf_den_bones"
  | "briar_fallen_hollow_log"
  | "briar_poison_thorn_bulb_cluster"
  | "briar_muddy_bog_patch"
  | "nightmire_dense_dark_canopy_tree"
  | "nightmire_ancient_elder_moss_stump"
  | "nightmire_bat_roost_dead_tree"
  | "nightmire_cinder_veined_standing_stone"
  | "nightmire_shadow_bramble_cluster"
  | "nightmire_fallen_canopy_trunk"
  | "nightmire_mushroom_ring"
  | "nightmire_hanging_root_curtain"
  | "nightmire_ash_moss_boulder_cluster"
  | "nightmire_corrupted_sap_patch"
  | "nightmire_broken_hunter_signpost"
  | "orc_warcamp_heavy_orc_spike_barricade"
  | "orc_warcamp_orc_command_banner_standard"
  | "orc_warcamp_crude_war_drum_platform"
  | "orc_warcamp_armored_watchtower_platform"
  | "orc_warcamp_orc_weapon_rack"
  | "orc_warcamp_bonfire_meat_spit"
  | "orc_warcamp_orc_training_post"
  | "orc_warcamp_orc_supply_pile"
  | "orc_warcamp_broken_siege_ram"
  | "orc_warcamp_skull_bone_trophy_mound"
  | "orc_warcamp_scorched_battlefield_patch";
