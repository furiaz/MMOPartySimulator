...
const mapOneStressEnemyStartData: EnemyStartData[] = [
  ...
  { id: enemyIds[48], position: { x: 17, y: 18 }, archetypeId: "slime", subzoneId: "shore-fringe", encounterAreaId: "shore-fringe-north-den" },
  ...
  { id: enemyIds[57], position: { x: 68, y: 20 }, archetypeId: "cave_bat", subzoneId: "mossy-glade", encounterAreaId: "mossy-glade-north-roost" },
  { id: enemyIds[58], position: { x: 84, y: 13 }, archetypeId: "cave_bat", subzoneId: "mossy-glade", encounterAreaId: "mossy-glade-north-roost" },
  { id: enemyIds[59], position: { x: 100, y: 17 }, archetypeId: "cave_bat", subzoneId: "mossy-glade", encounterAreaId: "mossy-glade-north-roost" },
  ...
  { id: enemyIds[62], position: { x: 84, y: 35 }, archetypeId: "cave_bat", subzoneId: "mossy-glade", encounterAreaId: "mossy-glade-south-roost" },
  ...
  { id: enemyIds[70], position: { x: 139, y: 39 }, archetypeId: "forest_spider", subzoneId: "lower-shore", encounterAreaId: "lower-shore-south-nest" },
